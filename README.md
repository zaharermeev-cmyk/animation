...
прибегает лиса в маске, берёт одну монету в зубы и убегает прямо налево за край экрана. Длится ~12 с, затем весь фон начинается заново. Рисуется линиями цвета `--scene-ink`,
...
В панели «Эффекты» (по умолчанию все включены, выбор запоминается в браузере):
